  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <motion.h1
          className="flex flex-col text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight leading-none mb-2"
          variants={fadeInUp}
        >
          <span className="font-bold text-background">SABORES</span>
          <span className="font-regular text-primary mt-2">AUTÉNTICOS</span>
        </motion.h1>
        <motion.p
        ...
        >
          <Link
            href="/menu"
            className="inline-flex items-center justify-center bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 transition-all duration-300 font-semibold tracking-wide rounded-sm px-8 py-3 text-sm uppercase"
          >
            ENCARGA TU PEDIDO
