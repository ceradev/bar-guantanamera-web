            ...
            <div className="bg-card divide-y divide-border">
                {items.length === 0 ? (
                    ...
                    items.map((item) => {
                        ...
                        return (
                            <div key={itemKey} className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 gap-6 items-center group transition-colors hover:bg-muted/5">
                                {/* Product Info */}
                                <div className="md:col-span-5 flex items-center gap-6">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {optionsText && (
                                            <p className="text-[10px] md:text-xs font-semibold text-primary uppercase tracking-wider mb-1">
                                                {optionsText}
                                            </p>
                                        )}
                                        {item.description && (
                                            <p className="text-xs text-muted-foreground hidden md:line-clamp-2">
                                                {item.description}
                                            </p>
                                        )}
                                    </div>
