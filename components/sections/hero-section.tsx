  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.p
          variants={itemVariants}
          className="text-xl md:text-2xl text-white/90 mb-16 max-w-3xl mx-auto leading-relaxed font-light"
        >
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-8 justify-center items-center">
          <Button
            asChild
            size="lg"
            className="bg-red-600 hover:bg-red-700 text-white px-10 py-6 text-lg font-semibold shadow-2xl hover:shadow-red-600/25 transition-all duration-300 group rounded-full border-2 border-transparent hover:border-red-400"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="border-2 border-white/30 text-white hover:bg-white hover:text-gray-900 px-10 py-6 text-lg font-semibold transition-all duration-300 group bg-white/10 backdrop-blur-sm rounded-full hover:border-white"
          >
